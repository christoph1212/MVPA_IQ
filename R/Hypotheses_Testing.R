...
EEG_Pre_EO <- readMat("Data/Ready_for_DDTBOX/EEG_sorted_cond/Full_Sample/Total/Pre/EyesOpen/eeg_sorted_cond.mat")
...
# Get EEG Data and add to data frame
EEG_Pre_EC <- readMat("Data/Ready_for_DDTBOX/EEG_sorted_cond/Full_Sample/Total/Pre/EyesClosed/eeg_sorted_cond.mat")
...
# Get EEG Data and add to data frame
EEG_Post_EO <- readMat("Data/Ready_for_DDTBOX/EEG_sorted_cond/Full_Sample/Total/Post/EyesOpen/eeg_sorted_cond.mat")
...
# Get EEG Data and add to data frame
EEG_Post_EC <- readMat("Data/Ready_for_DDTBOX/EEG_sorted_cond/Full_Sample/Total/Post/EyesClosed/eeg_sorted_cond.mat")
...
model_fluid_pre <- lm(fluid_score ~ crystallized_score, data = Pre_Data)
fluid_residuals_pre <- residuals(model_fluid_pre)
Pre_Data$fluid_scores_adj <- fluid_residuals_pre

model_cryst_pre <- lm(crystallized_score ~ fluid_score, data = Pre_Data)
cryst_residuals_pre <- residuals(model_cryst_pre)
Pre_Data$cryst_scores_adj <- cryst_residuals_pre
...
model_fluid_post <- lm(fluid_score ~ crystallized_score, data = Post_Data)
fluid_residuals_post <- residuals(model_fluid_post)
Post_Data$fluid_scores_adj <- fluid_residuals_post

model_cryst_post <- lm(crystallized_score ~ fluid_score, data = Post_Data)
cryst_residuals_post <- residuals(model_cryst_post)
Post_Data$cryst_scores_adj <- cryst_residuals_post
...
model_fluid <- lm(fluid_score ~ crystallized_score, data = Data)
fluid_residuals <- residuals(model_fluid)
Data$fluid_scores_adj <- fluid_residuals

model_cryst <- lm(crystallized_score ~ fluid_score, data = Data)
cryst_residuals <- residuals(model_cryst)
Data$cryst_scores_adj <- cryst_residuals

############################################
############### Hypothesis 2 ###############
############################################

corr_theta_fluid_adj <- cor.test(Data$mean_theta,Data$fluid_scores_adj, method = "spearman", exact = F, alternative = "less")
corr_alpha_fluid_adj <- cor.test(Data$mean_alpha,Data$fluid_scores_adj, method = "spearman", exact = F, alternative = "greater")
...
corr_fluid_sleep_Pre <- cor.test(Pre_Data$fluid_score, Pre_Data$sleepiness_score, method = "spearman", exact = F, alternative = "less")
spearman_ci(Pre_Data$fluid_score, Pre_Data$sleepiness_score, corr_fluid_sleep_Pre)


#corr_fluid_sleep_Post <- cor.test(Post_Data$fluid_score, Post_Data$sleepiness_score, method = "spearman", exact = F, alternative = "less")
corr_cryst_sleep_Pre <- cor.test(Pre_Data$crystallized_score, Pre_Data$sleepiness_score, method = "spearman", exact = F, alternative = "less")
spearman_ci(Pre_Data$crystallized_score, Pre_Data$sleepiness_score, corr_cryst_sleep_Pre)


#corr_cryst_sleep_Post <- cor.test(Post_Data$crystallized_score, Post_Data$sleepiness_score, method = "spearman", exact = F, alternative = "less")

p.adjust(c(corr_fluid_sleep_Pre$p.value, corr_cryst_sleep_Pre$p.value), method = "holm")
