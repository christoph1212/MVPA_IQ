...
post_EC_file_name = fullfile(OutputFolderBehav, folders(i_behav), 'Post', 'EyesClosed', 'eeg_sorted_cond_regress_sorted_cond');

if ~(isfolder(fullfile(OutputFolderBehav, folders(i_behav), 'Post', 'EyesClosed')))
    mkdir(fullfile(OutputFolderBehav, folders(i_behav), 'Post', 'EyesClosed'))
end  
