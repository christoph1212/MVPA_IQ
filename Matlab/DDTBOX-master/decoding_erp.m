...
[RESULTS] = prepare_my_vectors_erp_parfor(training_set, test_set, cfg);
...
if cfg.cross == 0 % If not using cross-decoding
    ...
    savename = [convertStringsToChars(cfg.output_dir) cfg.study_name '_cvsteps' ...
        num2str(cfg.cross_val_steps) '_cvreps' num2str(cfg.n_rep_cross_val) ...
        '_permrep' num2str(cfg.permut_rep) '_' cfg.dcg_labels{cfg.dcg_todo(1)} '.mat'];
...
elseif cfg.cross == 1 % Cross-decoding (train dcg 1, test dcg 2)
    ...
    savename = [(cfg.output_dir) cfg.study_name '_SBJ' num2str(cfg.sbj) ...
        ...
        '_av' num2str(cfg.avmode) '_st' num2str(cfg.stmode) '_cvsteps' ...
        num2str(cfg.cross_val_steps) '_cvreps' num2str(cfg.n_rep_cross_val) ...
        '_permrep' num2str(cfg.permut_rep) '_' cfg.analysis_mode_label ...
        '_DCG' cfg.dcg_labels{cfg.dcg_todo(1)} 'toDCG.mat'];
